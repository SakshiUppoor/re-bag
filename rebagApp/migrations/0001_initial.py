    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rebagApp.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
                ...
                ('auction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rebagApp.Auction')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subcategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rebagApp.Subcategory')),
            ],
        ),
        migrations.CreateModel(
            name='Image',
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rebagApp.Item')),
            ],
        ),
        migrations.CreateModel(
            name='CustomerCare',
        ...
        migrations.AddField(
            model_name='auction',
            name='item',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='rebagApp.Item'),
        ),
    ]
